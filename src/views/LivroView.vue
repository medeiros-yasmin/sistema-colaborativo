                                    ...
                                    <v-row class="bottom-left" style="padding-left:18px; padding-top:8px"
                                        ...
                                        <v-card-actions class="d-flex align-end">
                                            ...
                                            <v-btn class=" white--text" rounded color="#C198C4"
                                                :to="{ name: 'publicacao', params: { id: podcast.id, tipoPublicacao: 'livros' } }">
                                                Visualizar
                                            </v-btn>
    ...
    methods: {
        ...
        async adicionarAgradecimento(publicacaoId) {
            ...
            try {
                ...
                const publicacaoRef = doc(db, 'livros', publicacaoId);
        ...
        async confirmarDelecao() {
            if (this.publicacaoSelecionada) {
                const docRef = doc(db, 'livros', this.publicacaoSelecionada);
