            ...
            <v-container>
                <v-row>
                    <v-col v-for="item in items" :key="item.id" cols="4">
                        ...
                        <v-card shaped style="margin-top:18px" :color="item.cardColor" :elevation="item - 10"
                            @mouseover="item.isHovered = true" @mouseout="item.isHovered = false"
                            :class=" { 'card-hovered': item.isHovered }" height="330" width="1000" class="overflow-hidden mx-auto white--text card-original-color">
                            <v-menu bottom left>
...
export default {
    ...
    data: () => ({
        ...
        items: [
            { id: 0, title: 'Artigos', isHovered: false },
            { id: 1, title: 'Auxílios' , isHovered: false },
            { id: 2, title: 'Podcasts', isHovered: false },
            { id: 3, title: 'Sites', isHovered: false },
            { id: 4, title: 'Vídeos', isHovered: false },
            { id: 5, title: 'Livros e Revistas', isHovered: false },
        ],
