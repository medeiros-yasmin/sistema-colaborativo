            ...
            <v-container>
                <v-row>
                    <v-col v-for="auxilio in auxilios" :key="auxilio.id" cols="112">
                        ...
                        <v-card style="margin-top:18px"  color="#5C3C6C" :elevation="auxilio - 1" class="mx-auto white--text" height="330" width="1000">
                            <div class="d-flex flex-no-wrap justify-space-between">
                                <div style="margin-top:18px; margin-left: 18px; margin-right: 320px">
                                    ...
                                    <v-card-text class="text-justify text-h7 font-weight-bold" v-text="auxilio.descricao"></v-card-text>
                                    
                                    <v-row class="bottom-left" style="padding-left:18px; padding-top:8px"
                                        text-align="bottom" >
                                    <v-card-actions>
                                        <v-btn class="white--text" rounded color="#C198C4" :to="{ name: 'publicacao', params: { id: auxilio.id, tipoPublicacao: 'auxilio' } }">
                                            Visualizar
                                        </v-btn>
                                    </v-card-actions>
                                    <v-card-actions>
                                        <v-btn class="white--text" rounded color="cyan" @click="deletarPublicacao(auxilio.id)">
                                            Deletar
                                        </v-btn>
                                    </v-card-actions>
                                    </v-row>
